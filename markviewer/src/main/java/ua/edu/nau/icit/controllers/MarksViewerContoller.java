package ua.edu.nau.icit.controllers;
...
import ua.edu.nau.icit.classes.Session;
import ua.edu.nau.icit.classes.Task;
import ua.edu.nau.icit.function.DbWorker;
    ...
    public void choice_session(final ActionEvent actionEvent) {
        ...
        class EventHandlerViewPreviewImpl implements EventHandler<ActionEvent> {
            ...
            public void handle(ActionEvent e) {
                FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("preview.fxml"));
