package ua.edu.nau.icit.mode_selection;
...
import ua.edu.nau.icit.controllers.main_C;
import ua.edu.nau.icit.models.Main;
...
public class win_choiser {
    ...
    public void win_choiser(int mode, Stage win) {
        ...
        switch (mode) {
            case 0: {
                try {
                    root = FXMLLoader.load(getClass().getResource("create_arch.fxml"));
            ...
            case 2: {
                try {
                    root = FXMLLoader.load(getClass().getResource("rating_arch.fxml"));
            ...
            case 1: {
                try {
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("main_window_V2.fxml"));
                    ...
                    main_C controller = loader.getController();
                    controller.initData();
