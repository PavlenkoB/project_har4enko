...
import ua.edu.nau.icit.classes.LogIn;
import ua.edu.nau.icit.controller.RatingArchController;
...
public class Controller_mode_selection_user_menu implements Initializable {
    ...
    public void close(ActionEvent actionEvent) throws IOException {
        try {
            ...
            Parent root;
            root = FXMLLoader.load(getClass().getResource("Close.fxml"));
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            logining_read = new BufferedReader(new FileReader(getClass().getClassLoader().getResource("ssap").getFile()));
            String line;
