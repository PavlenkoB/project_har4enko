package ua.edu.nau.icit.controller;
...
import ua.edu.nau.icit.DBWorker;
import ua.edu.nau.icit.classes.Architecture;
import ua.edu.nau.icit.classes.Criterion;
import ua.edu.nau.icit.classes.Mark;
import ua.edu.nau.icit.classes.Task;
...
import static ua.edu.nau.icit.classes.Architecture.arch_image_gen_with_patterns;
...
//    String mark_db_str = "DB/Marks";
    ...
    public void close(ActionEvent actionEvent) throws IOException {
        try {
            ...
            Parent root;
            root = FXMLLoader.load(getClass().getClassLoader().getResource("Close.fxml"));
