...
import ua.edu.nau.icit.classes.DerbyDBManager;
...
public class functions {
     ...
     */
    public static Image draw_class_image(String class_text) {
    ...
    public static Image drawClassImageThread(String class_text, Integer id) {
        Image class_image = null;
        if (class_text != null) {
            String sourse = "@startuml\n" +
                    "skinparam backgroundColor transparent\n" + //Прозрачный фон
    ...
    public static Image drawClassImageThread(String class_text) {
