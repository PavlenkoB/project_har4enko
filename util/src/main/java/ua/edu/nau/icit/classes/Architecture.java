...
import ua.edu.nau.icit.services.ImageConverter;
import ua.edu.nau.icit.services.DrawUml;
...
public class Architecture implements Cloneable {
    ...
    private Image preview;                   //architecture preview
     ...
     */
    public static Image arch_image_gen_with_patterns(Architecture architecture) {
    ...
    public boolean equals(Object o) {
        ...
        return !(idDone != null ? !idDone.equals(that.idDone) : that.idDone != null);
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + idDone.hashCode();
        return result;
    }
}
