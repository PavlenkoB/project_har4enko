 ...
 */
public class MVDbWorker {
    private static MVDbWorker ourInstance = new MVDbWorker();
    private static Logger logger = Logger.getLogger(MVDbWorker.ourInstance.getClass());
    /**
    ...
    public static MVDbWorker getInstance() {
        return ourInstance;
    }
