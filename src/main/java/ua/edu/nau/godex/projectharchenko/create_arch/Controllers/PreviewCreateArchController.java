 ...
 */
public class PreviewCreateArchController implements Initializable {

    public static Logger logger = Logger.getLogger(PreviewCreateArchController.class.getName());
            ...
            Platform.runLater(new Runnable() {
                ...
                public void run() {
                    while (true){
                        ...
                        flag_thread = false;
                        int iter_sleep = 0;
                        logger.info(flag_thread);
                        while (!flag_thread) {
                            logger.info("sl" + ++iter_sleep + " ");
                            try {
                                myThread.sleep(1000);
