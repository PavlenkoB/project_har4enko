...
public class Architecture implements Cloneable {
    ...
    public boolean equals(Object obj) {
        Architecture inputArch = null;
        try {
            inputArch = (Architecture) obj;
        } catch (ClassCastException e) {
            return false;
        }
        return inputArch != null && inputArch.id.equals(this.id) && inputArch.description.equalsIgnoreCase(this.description);
    }
}
