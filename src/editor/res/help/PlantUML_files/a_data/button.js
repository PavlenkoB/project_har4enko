...
var Try = {these: function () {
    ...
    if (!d)return;
    if (null !== b && "function" == typeof b)b.onSuccess = b; else if (!b.onSuccess)return!1;
    var e = c ? "post" : b.method ? b.method : "get";
    d.open(e, a, !0), d.setRequestHeader("X-REQUESTED-WITH", "XMLHttpRequest");
    var f = getCookie("f_rt");
    f && (b.headers = {"REQUEST-TOKEN": f});
    if (b.headers)for (header in b.headers)d.setRequestHeader("X-" + header, b.headers[header]);
    e == "post" && d.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), d.onreadystatechange = function () {
    ...
    if (d.readyState == 4)return;
    return d.send(c), !0
}}, FlattrButton = {click: function (a) {
    var b = {onSuccess: function (a) {
        window.parent.postMessage(JSON.stringify({flattr_button_event: "click_successful"}), "*"), replaceWith("flattr-1", a), setTimeout(function () {
