...
(function () {
    ...
    var Lb = decodeURI("%73cript"), Mb = function (a, b) {
        ...
        var n = S(mb(c), "r", []).sort(), m = S(mb(c), "L", []).sort(), p = [][ka](n), w = function (a, b) {
            if (l)return 0;
            Q.clearTimeout(h);
            m[F][E](m, C);
            var d = ((W || {}).config || {})[Ca];
    ...
    var cd = {U: "se"}, dd = {U: "ad"}, ed = {ad: {"true": "1", "false": "2"}}, fd = {post: !0}, gd = {style: "position:absolute;top:-10000px;width:450px;margin:0px;border-style:none"}, hd = "onPlusOne _ready _close _open _resizeMe _renderstart oncircled drefresh erefresh".split(" "), id = S(Y, "WI", T()), jd = function (a, b, c) {
        var d, e;
        d = {};
        var f = e = a;
        "plus" == a && b[ra] && (e = a + "_" + b[ra], f = a + "/" + b[ra]);
        (e = Z("iframes/" + e + "/url")) || (e = ":im_socialhost:/:session_prefix::im_prefix:_/widget/render/" + f + "?usegapi=1");
        for (var g in cd)if (f = cd[g], b[f])d[f] =
            f + "/" + b[f] + "/"; else {
            var h = dd[g];
            h && b[h] && (d[f] = f + "/" + ed[h][b[h]] + "/")
        }
        d = $a(R, e[s](Pc, Sc(d)));
        e = "iframes/" + a + "/params/";
        g = {};
        V(b, g);
        (f = Z("lang") || Z("gwidget/lang")) && (g.hl = f);
        fd[a] || (g.origin = k[A].origin || k[A][qa] + "//" + k[A].host);
        g.exp = Z(e + "exp");
        if (e = Z(e + "location"))for (f = 0; f < e[I]; f++)h = e[f], g[h] = Q[A][h];
        switch (a) {
            case "plus":
            case "follow":
                e = g[D];
                f = b[ra] ? void 0 : "publisher";
                e = (e = "string" == typeof e ? e : void 0) ? ad(e) : bd(f);
                g.url = e;
                delete g[D];
                break;
            case "plusone":
                ...
                f =
                    Z();
                null == e && f && (e = f.db, null == e && (e = f.gwidget && f.gwidget.db));
                g.db = e || void 0;
                e = b.ecp;
                f = Z();
                null == e && f && (e = f.ecp, null == e && (e = f.gwidget && f.gwidget.ecp));
                g.ecp = e || void 0;
                delete g[D];
                break;
            case "signin":
        ...
        delete g.rd;
        for (var l in cd)e = cd[l], g[e] && delete g[e];
        g.gsrc = Z("iframes/:source:");
        l = Z("inline/css");
        "undefined" !== typeof l && 0 < c && l >= c && (g.ic = "1");
        l = /^#|^fr-/;
        c = {};
        for (var n in g)U(g, n) && l[G](n) && (c[n[s](l, "")] = g[n], delete g[n]);
        n = "q" == Z("iframes/" +
            a + "/params/si") ? g : c;
        l = ec();
        for (var m in l)!U(l, m) || U(g, m) || U(c, m) || (n[m] = l[m]);
        m = [][ka](hd);
        (n = Z("iframes/" + a + "/methods")) && "object" === typeof n && Ja[G](n[F]) && (m = m[ka](n));
        for (var p in b)U(b, p) && /^on/[G](p) && ("plus" != a || "onconnect" != p) && (m[F](p), delete g[p]);
        delete g.callback;
        c._methods = m[P](",");
        return Za(d, g, c)
        ...
        for (var b = T(), c = 0 != a[xa][Da]()[H]("g:"), d = 0, e = a[sa][I]; d < e; d++) {
            ...
            0 <= Ka[L](kd, g) || c && 0 != g[H]("data-") || "null" ===
                h || "specified"in f && !f.specified || (c && (g = g[x](5)), b[g[Da]()] = h)
        }
        a = a[B];
        (c = ld(a && a[ta])) && (b.height = r(c));
        ...
        kc(function (b) {
            if (a !== b.id && 4 != b.state && "share" != b[ya]) {
                ...
                if (f) {
                    var g = jd(d, b, 0);
                    g ? (f = f[O], e[s](/\#.*/, "")[s](/(\?|&)ic=1/, "") !== g[s](/\#.*/, "")[s](/(\?|&)ic=1/, "") && (b.dontclear = !0, b.rd = !0, b.ri = !0, fa(b, d), nd(f, b), (d = $[f.lastChild.id]) && (d.oid = c), lc(c, 4))) : delete $[c]
                } else delete $[c]
            }
        })
    };
    var pd, qd, rd, sd, td, ud = /(?:^|\s)g-((\S)*)(?:$|\s)/, vd = {plusone: !0, autocomplete: !0, profile: !0, signin: !0};
    pd = S(Y, "SW", T());
    qd = S(Y, "SA", T());
    rd = S(Y, "SM", T());
    sd = S(Y, "FW", []);
    ...
    var xd = function (a, b) {
        ...
        for (f = 0; f < e[I]; f++) {
            ...
            l[M]("data-gapiscan") ? h = null : (0 == n[H]("g:") ? m = n[x](2) : (l = (l = r(l.className || l[M]("class"))) && ud[ia](l)) && (m = l[1]), h = !m || !(pd[m] ||
                qd[m] || rd[m]) || h && m !== h ? null : m);
            h && (vd[h] || 0 == g[xa][Da]()[H]("g:") || 0 != Sa(md(g))[I]) && (g[v]("data-gapiscan", !0), S(c, h, [])[F](g))
        }
        ...
        if (yd(td || {}))for (var u in c) {
            ...
            d = [];
            for (u in c)for (a = c[u], w = 0, b = a[I]; w < b; w++)e = a[w], Ad(u, e, md(e), d, b);
            Bd(p, d)
        }
    }, Cd = function (a) {
        var b =
        ...
        switch (Gd(b, a, f)) {
            ...
            case 1:
                ...
                if (b[O]) {
                    ...
                    e.siteElement = m;
                    m.id || (b = m, S(id, a, 0), n = "___" + a + "_" + id[a]++, b.id = n);
                    b = T();
                    b[">type"] = a;
                    V(c, b);
                    n = f;
    ...
    Pd[K].write = function (a, b) {
        if (!Rd[G](this.B))throw"Invalid cookie name";
    ...
    var Ud = "https:" === k[A][qa], Vd = Ud || "http:" === k[A][qa] ? Pd : Sd, Wd = function (a) {
        ...
        d = "E" ===
            c && e.d;
        return!d && ("U" !== c || e.d) || d && !Ud ? b : {w: !0, d: d, W: a[x](1), domain: e.domain, i: e.i}
    }, Yd = function (a) {
        if (!a)return[];
        a = a[z]("=");
        return a[1] ? a[1][z]("|") : []
        ...
        a = a[z](":");
        return{t: a[0][z]("=")[1], O: Yd(a[1]), $: Yd(a[2]), Z: Yd(a[3])}
    }, $d = function () {
        var a, b = null;
    ...
    var ce = null, ic = function () {
        return Y.oa = !0
    }, jc = function () {
        Y.oa = !0;
        var a = $d();
        (a = a && a.P) && $b("googleapis.config/sessionIndex", a);
        ce || (ce = S(Y, "ss", new ae(de)));
        a = ce;
        a.L && a.L()
    }, de = function () {
        var a = $d(), b = a && a.Q || null, c = a && a.t;
        Tb("auth", {callback: function () {
            ...
            a.checkSessionState(e, function (b) {
                ...
                if (h = h != b)$b("isLoggedIn", b), jc(), od(), b || ((b = a.signOut) ? b() : (b = a.setToken) && b(null));
                b =
                    ec();
