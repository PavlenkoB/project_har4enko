...
__twttrlr(function (using, provide, loadrunner, define) {
    ...
    provide("util/twitter", function (e) {
        using("util/querystring", function (t) {
            ...
            e({isHashTag: c, hashTag: h, isScreenName: u, screenName: a, isStatus: p, status: d, intentForProfileURL: f, intentForFollowURL: l, isTwitterURL: v, isTwimgURL: m, regexen: {profile: n}})
        })
    });
    ...
    provide("dom/delegate", function (e) {
        ...
        function s(e, t, n) {
            var r = n || e.target || e.srcElement, o = r.className.split(" "), u = 0, a = o.length;
        ...
        var t = {}, n = -1;
        e({stop: l, stopPropagation: h, preventDefault: c, delegate: u, on: a, simulate: f})
    });
    ...
    provide("util/logger", function (e) {
        ...
        var t = ["con", "sole"].join(""), n = {}, r = !!~location.href.indexOf("tw_debug=true");
        e({info: i, warn: s, error: o, time: u, timeEnd: a})
    });
    provide("util/domready", function (e) {
        ...
        var t = 0, n = [], r, i, s = !1, o = document.createElement("a"), u = "DOMContentLoaded", a = "addEventListener", f = "onreadystatechange", l;
    ...
    provide("tfw/util/media", function (e) {
        using("dom/get", "util/util", "util/env", function (t, n, r) {
            ...
            function l(e, t) {
                var n = e.getAttribute("data-srcset"), r = e.src, i;
            ...
            function h(e, r, a, f) {
                var c = 0, h = a ? 600 : 375, d = t.one("multi-photo", e, "DIV"), v = d && +d.getAttribute("data-photo-count");
                if (!e)return;
                return n.forEach(t.all("autosized-media", e), function (e) {
                    ...
                    var t = r - 12, n = e.parentNode, a = e.getAttribute("data-crop-x") || 0, d = e.getAttribute("data-crop-y") || 0, m, g, y = u(v, e.getAttribute("data-image-index")), b = Math.floor(t / 2 - i), w = Math.floor(b / (y ? s : o)), E;
            ...
            var i = 6, s = 8 / 9, o = 16 / 9;
            e({scaleDimensions: p, retinize: c, constrainMedia: h, __setSrcFromSet: l})
        })
    });
    ...
    provide("anim/transition", function (e) {
        ...
        function r(e, n, r, i, s) {
            function u() {
                var a = +(new Date), f = a - o, l = Math.min(f / r, 1), c = i ? i(n, l) : n * l;
                e(c);
                if (l == 1)return;
                t(u, s)
            }
    ...
    provide("tfw/util/assets", function (e) {
        using("util/env", function (t) {
            ...
            var n = {"embed/timeline.css": {"default": "embed/timeline.295a00bf5122128e332d25515711dbbd.default.css", "2x": "embed/timeline.295a00bf5122128e332d25515711dbbd.2x.css", gif: "embed/timeline.295a00bf5122128e332d25515711dbbd.gif.css", "default.rtl": "embed/timeline.295a00bf5122128e332d25515711dbbd.default.rtl.css", "2x.rtl": "embed/timeline.295a00bf5122128e332d25515711dbbd.2x.rtl.css", "gif.rtl": "embed/timeline.295a00bf5122128e332d25515711dbbd.gif.rtl.css"}};
            e(r)
        })
    });
        ...
        using("util/promise", function (t) {
            ...
            i.prototype.enqueue = function (e, r) {
                return new t(function (t) {
                    n.push({action: e, resolver: t, note: r})
                })
    ...
    provide("tfw/widget/base", function (e) {
        using("dom/get", "util/domready", "util/iframe", "util/layout", "util/promise", "util/querystring", "util/typevalidator", "util/util", "tfw/util/globals", "util/logger", function (t, n, r, i, s, o, u, a, f, l) {
            ...
            a.aug(y.prototype, {setLanguage: function (e) {
                ...
                var i = this, o;
                return n[m] = !0, o = r(a.aug({id: this.id, src: e, "class": this.classAttr.join(" ")}, n), t, this.targetEl && this.targetEl.ownerDocument), this.srcEl ? this.layout(function () {
                ...
                u.isArray(e) || (e = [e || document]), l.time("sandboxes"), a.forEach(e, function (e) {
                    ...
                    if (!e.length)return;
                    twttr.events.trigger("loaded", {widgets: e}), l.timeEnd("load")
                }), y.doLayoutAsync(), b()
    ...
    provide("tfw/widget/intent", function (e) {
        using("tfw/widget/base", "util/util", "util/querystring", "util/uri", "util/promise", function (t, n, r, i, s) {
            ...
            b.prototype = new t, n.aug(b.prototype, {render: function () {
    ...
    provide("tfw/widget/syndicatedbase", function (e) {
        using("tfw/widget/base", "tfw/widget/intent", "tfw/util/assets", "tfw/util/globals", "tfw/util/media", "tfw/util/tracking", "dom/classname", "dom/get", "dom/delegate", "sandbox/frame", "util/env", "util/promise", "util/twitter", "util/typevalidator", "util/util", function (t, n, r, i, s, o, u, a, f, l, c, h, p, d, v) {
            ...
            var m = [".customisable", ".customisable:link", ".customisable:visited", ".customisable:hover", ".customisable:focus", ".customisable:active", ".customisable-highlight:hover", ".customisable-highlight:focus", "a:hover .customisable-highlight", "a:focus .customisable-highlight"], g = ["a:hover .ic-mask", "a:focus .ic-mask"], y = [".customisable-border"], b = [".timeline-header h1.summary", ".timeline-header h1.summary a:link", ".timeline-header h1.summary a:visited"], w, E, S, x = {TWEET: 0, RETWEET: 10};
            N.prototype = new t, v.aug(N.prototype, {setupSandbox: function (e) {
                ...
                function r(n) {
                    var r = a.ancestor(".tweet", this, t), i = v.aug({}, e.baseScribeData(), e.extractTweetScribeDetails(r));
                ...
                var t, n, r = {};
                return e ? (t = e.getAttribute("data-tweet-id"), n = e.getAttribute("data-rendered-tweet-id") || t, n == t ? r[n] = {item_type: x.TWEET} : t && (r[n] = {item_type: x.RETWEET, target_type: x.TWEET, target_id: t}), r) : r
                ...
                v.forEach(a.all("collapsible-container", this.element), v.bind(function (e) {
                    var t = e.children, n = t.length && e.offsetWidth, r = t.length && v.map(t, function (e) {
        ...
        using("tfw/widget/base", "tfw/widget/syndicatedbase", "util/datetime", "util/promise", "anim/transition", "tfw/util/article", "tfw/util/data", "tfw/util/media", "tfw/util/tracking", "tfw/util/params", "util/css", "util/env", "util/throttle", "util/twitter", "util/querystring", "util/typevalidator", "util/util", "dom/delegate", "dom/classname", "dom/get", function (t, n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b, w) {
            ...
            q.prototype = new n, g.aug(q.prototype, {renderedClassNames: "twitter-timeline twitter-timeline-rendered", dimensions: {DEFAULT_HEIGHT: "600", DEFAULT_WIDTH: "520", NARROW_WIDTH: "320", MIN_WIDTH: "180", MIN_HEIGHT: "200", WIDE_MEDIA_PADDING: 81, NARROW_MEDIA_PADDING: 16, WIDE_MEDIA_PADDING_CL: 60, NARROW_MEDIA_PADDING_CL: 12}, create: function (e) {
                ...
                return this.reconfigure(e.config), this.discardStaticOverflow(r), this.sandbox.setTitle(r.getAttribute("data-iframe-title") || "Timeline"), a.retinize(r), this.constrainMedia(r), this.searchQuery = r.getAttribute("data-search-query"), this.profileId = r.getAttribute("data-profile-id"), this.timelineType = r.getAttribute("data-timeline-type"), l = this.getTweetDetails(n), g.forIn(l, function (e) {
                    u.push(e)
                }), o = this.baseScribeData(), o.item_ids = u, o.item_details = l, this.timelineType && f.enqueue({page: this.timelineType + "_timeline", component: "timeline", element: "initial", action: u.length ? "results" : "no_results"}, o, !0, this.dnt), f.enqueue({page: "timeline", component: "timeline", element: "initial", action: u.length ? "results" : "no_results"}, o, !0, this.dnt), f.flush(), this.ariaPolite == "assertive" && (s = w.one(T, r, "DIV"), s.setAttribute("aria-polite", "assertive")), r.id = this.id, r.className += " " + this.classAttr.join(" "), r.lang = this.lang, this.augmentWidgets(r), this.ready().then(g.bind(function (e) {
                    e.appendChild(r).then(g.bind(function () {
                        this.renderResolver.fulfill(this.sandbox)
                    }, this)), e.style({cssText: "", border: "none", maxWidth: "100%", minWidth: this.dimensions.MIN_WIDTH + "px"}), this.layout(g.bind(function () {
                ...
                u.timelinePreview({success: g.bind(function (e) {
                ...
                f.initPostLogging(), u.timeline(g.aug({id: this.widgetId, instanceId: this.instanceId, dnt: this.dnt, lang: this.lang, success: g.bind(function (e) {
                    this.ready().then(g.bind(function () {
                ...
                var t = w.one(L, e), n, r = {}, i, s, o = 0;
                n = t && t.children || [];
                for (; i = n[o]; o++)s = w.one(D, i, "A"), g.aug(r, this.extractTweetScribeDetails(i));
                return r
            }, baseScribeData: function () {
                return{widget_id: this.widgetId, widget_origin: o.url(), client_version: E, message: this.partner, query: this.searchQuery, profile_id: this.profileId}
                ...
                var e = this, t = w.one(L, this.element), n = t && t.children[0], r = n && n.getAttribute("data-tweet-id");
                this.updateTimeStamps(), this.requestTweets(r, !0, function (t) {
                    t.childNodes.length > 0 && e.insertNewTweets(t)
                })
            }, loadMore: function () {
                var e = this, t = w.all(A, this.element, "LI").pop(), n = t && t.getAttribute("data-tweet-id");
                this.requestTweets(n, !1, function (t) {
                    var r = w.one(H, e.element, "P"), i = t.childNodes[0];
                ...
                var e = this, t = !!w.all(L, this.element, "OL").length;
                ...
                var r = this, i = {id: this.widgetId, instanceId: this.instanceId, screenName: this.widgetScreenName, userId: this.widgetUserId, withReplies: this.widgetShowReplies, dnt: this.dnt, lang: this.lang};
                t && this.cursors.maxPosition ? i.minPosition = this.cursors.maxPosition : !t && this.cursors.minPosition ? i.maxPosition = this.cursors.minPosition : t ? i.sinceId = e : i.maxId = e, i.complete = function () {
                    ...
                    var i = r.sandbox.createDocumentFragment(), s = r.sandbox.createElement("div"), o, u = [], l, c;
                    r.updateCursors(e.headers, {newer: t}), e && e.headers && e.headers.xPolling && /\d+/.test(e.headers.xPolling) && (r.pollInterval = e.headers.xPolling * 1e3);
                ...
                var t = w.one(k, this.element, "DIV"), n = w.one(L, t, "OL");
                n.appendChild(e), this.updateTimeStamps()
            }, gcTweets: function (e) {
                var t = w.one(L, this.element, "OL"), n = t.children.length, r;
                e = e || 50;
                for (; n > e && (r = t.children[n - 1]); n--)t.removeChild(r)
            }, showNewTweetNotifier: function () {
                var e = this, t = w.one(T, this.element, "DIV"), n = t.children[0];
                ...
                var t = w.one("nsfw", e, "DIV"), n, r, i = 0, s, o, u, f;
                if (!t)return;
                ...
                var n = w.one(M, e, "DIV"), r = n && n.children[0], i = r && r.getAttribute("data-expanded-media"), s, o = 0, u = w.one(_, e, "A"), f = u && u.getElementsByTagName("B")[0], l = f && (f.innerText || f.textContent), c;
                if (!f)return;
                ...
                var t = w.one(N, this.element, "DIV"), n = w.one(C, this.element, "DIV"), r = w.one(k, this.element, "DIV");
                this.layout(g.bind(function () {
                ...
                }, this)) : (this.recalculateStreamHeight(n), twttr.events.trigger("resize", {target: this.sandbox.element()})), t.doLayoutAsync()
            }}), e(q)
        })
    });
    provide("tfw/widget/embed", function (e) {
        using("tfw/widget/base", "tfw/widget/syndicatedbase", "util/datetime", "tfw/util/params", "dom/classname", "dom/get", "util/env", "util/promise", "util/util", "util/throttle", "util/twitter", "tfw/util/article", "tfw/util/data", "tfw/util/tracking", "tfw/util/media", function (t, n, r, i, s, o, u, a, f, l, c, h, p, d, v) {
            ...
            function S(e, t, n) {
                var r = {};
                if (!e)return;
                r[e] = {item_type: 0}, d.enqueue({page: "tweet", section: "subject", component: "rawembedcode", action: "no_results"}, {client_version: m, widget_origin: h.url(), widget_frame: h.frameUrl(), message: t, item_ids: [e], item_details: r}, !0, n)
            }

            function x(e, t, n, r) {
                y[e] = y[e] || [], y[e].push({s: n, f: r, lang: t})
            }
            ...
            var m = "2.0", g = "tweetembed", y = {}, b = [], w = [];
            N.prototype = new n, f.aug(N.prototype, {renderedClassNames: "twitter-tweet twitter-tweet-rendered", dimensions: {DEFAULT_HEIGHT: "0", DEFAULT_WIDTH: "500", NARROW_WIDTH: "350", MIN_WIDTH: "220", MIN_HEIGHT: "0", WIDE_MEDIA_PADDING: 32, NARROW_MEDIA_PADDING: 32}, create: function (e) {
                var t = this.sandbox.createElement("div"), n, r;
                ...
                return this.theme == "dark" && this.classAttr.push("thm-dark"), this.linkColor && this.addSiteStyles(), s.present(n, "media-forward") && (this.fullBleedPhoto = !0), this.augmentWidgets(n), v.retinize(n), n.id = this.id, n.className += " " + this.classAttr.join(" "), n.lang = this.lang, this.sandbox.setTitle(n.getAttribute("data-iframe-title") || "Tweet"), this.sandbox.appendChild(n).then(f.bind(function () {
                    this.renderResolver.fulfill(this.sandbox)
                }, this)), this.sandbox.style({cssText: "", display: "block", maxWidth: "99%", minWidth: this.dimensions.MIN_WIDTH + "px", padding: "0", borderRadius: "5px", margin: "10px 0", border: "#ddd 1px solid", borderTopColor: "#eee", borderBottomColor: "#bbb", boxShadow: "0 1px 3px rgba(0,0,0,0.15)", position: "absolute", visibility: "hidden"}), r = this.layout(f.bind(function () {
                ...
                var t = this, n = {related: this.related, partner: this.partner, original_referer: h.url(), tw_p: g};
                return this.addUrlParams = i(n, function (e) {
                    var n = o.ancestor(".tweet", e, t.element);
                    return{tw_i: n.getAttribute("data-tweet-id")}
                }), this.addUrlParams(e)
            }, baseScribeData: function () {
                return{client_version: m, widget_origin: h.url(), widget_frame: h.frameUrl(), message: this.partner}
    ...
    provide("tfw/widget/follow", function (e) {
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "util/twitter", "util/promise", "dom/textsize", function (t, n, r, i, s, o, u) {
            ...
            a.prototype = new n, t.aug(a.prototype, {parameters: function () {
                ...
                var r = twttr.widgets.config.assetUrl() + "/widgets/follow_button.1404859412.html#" + this.parameters(), i = this.create(r, this.dimensions(), {title: this._("Twitter Follow Button")}).then(t.bind(function (e) {
    ...
    provide("tfw/widget/tweetbutton", function (e) {
        using("tfw/widget/base", "tfw/util/globals", "util/util", "util/querystring", "util/uri", "util/twitter", "util/typevalidator", "dom/textsize", function (t, n, r, i, s, o, u, a) {
            ...
            p.prototype = new t, r.aug(p.prototype, {widgetUrlParams: function () {
                ...
                var n = twttr.widgets.config.assetUrl() + "/widgets/tweet_button.1404859412.html#" + this.parameters(), i;
        ...
        window.twttr = window.twttr || {}, twttr.host = twttr.host || "platform.twitter.com", using("util/domready", "util/env", "util/logger", function (e, t, n) {
            ...
            twttr.events = {bind: function (e, t) {
                ...
                using("tfw/widget/base", "tfw/widget/follow", "tfw/widget/tweetbutton", "tfw/widget/embed", "tfw/widget/timeline", "tfw/widget/intent", "tfw/factories", "tfw/util/article", "util/events", "util/util", function (e, t, s, o, u, a, f, l, c, h) {
                    ...
                    var p = {widgets: {"a.twitter-share-button": s, "a.twitter-mention-button": s, "a.twitter-hashtag-button": s, "a.twitter-follow-button": t, "blockquote.twitter-tweet": o, "a.twitter-timeline": u, "div.twitter-timeline": u, body: a}}, d = twttr.events && twttr.events.hub ? twttr.events : {}, v;
                    p.assetUrl = m, twttr.widgets = twttr.widgets || {}, h.aug(twttr.widgets, f, {config: {assetUrl: m}, load: function (t) {
