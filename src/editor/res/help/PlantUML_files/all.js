/*1405758094,,JIT Construction: v1335099,en_US*/
...
try {
    window.FB || (function (window) {
        ...
        __d("ES", ["ES5ArrayPrototype", "ES5FunctionPrototype", "ES5StringPrototype", "ES5Array", "ES5Object", "ES5Date", "JSON3", "ES6Object"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
            var o = ({}).toString, p = {'JSON.stringify': m.stringify, 'JSON.parse': m.parse}, q = {'Array.prototype': g, 'Function.prototype': h, 'String.prototype': i, Object: k, Array: j, Date: l}, r = {Object: n};

            function s(u) {
                for (var v in u) {
                    if (!u.hasOwnProperty(v))continue;
                    var w = u[v], x = v.split('.'), y = x.length == 2 ? window[x[0]][x[1]] : window[v];
                    for (var z in w) {
            ...
            s(r);
            function t(u, v, w) {
                var x = Array.prototype.slice.call(arguments, 3), y = w ? o.call(u).slice(8, -1) + '.prototype' : u, z = p[y + '.' + v] || u[v];
        ...
        var ES = require('ES');
        __d("JSSDKRuntimeConfig", [], {"locale": "en_US", "rtl": false, "revision": "1335099"});
        ...
        __d("JSSDKConnectBarConfig", [], {"imgs": {"buttonUrl": "rsrc.php\/v2\/yY\/r\/h_Y6u1wrZPW.png", "missingProfileUrl": "rsrc.php\/v2\/yo\/r\/UlIqmHJn-SK.gif"}});
        ...
        __d("sdk.Impressions", ["guid", "QueryString", "sdk.Runtime", "UrlMap"], function (a, b, c, d, e, f, g, h, i, j) {
            ...
            var l = {log: function (m, n) {
                ...
                k({lid: m, payload: ES('JSON', 'stringify', false, n)});
            }, impression: k};
            e.exports = l;
        }, null);
        ...
        __d("ApiClient", ["ArgumentError", "Assert", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "sprintf", "sdk.URI", "UrlMap", "ApiClientConfig"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
            var s, t, u, v = {get: true, post: true, 'delete': true, put: true}, w = {fql_query: true, fql_multiquery: true, friends_get: true, notifications_get: true, stream_get: true, users_getinfo: true};
            ...
            function x(ca, da, ea, fa) {
                ...
                ea = k(ea);
                var ga = {jsonp: l, cors: i, flash: j}, ha;
                if (ea.transport) {
                    ha = [ea.transport];
                    delete ea.transport;
                } else ha = ['jsonp', 'cors', 'flash'];
                for (var ia = 0; ia < ha.length; ia++) {
                    var ja = ga[ha[ia]], ka = ES('Object', 'assign', false, {}, ea);
            ...
            function z(ca) {
                ...
                var ia = da.getQueryData(), ja = ES(y, 'bind', true, null, ha, da.getPath(), ga, ia), ka = da.getProtocol() && da.getDomain() ? da.setQueryData({}).toString() : q.resolve('graph') + da.getPath();
                ia.method = ga;
            ...
            function aa(ca, da) {
                ...
                ca.api_key = t;
                var fa = ea in w ? 'api_read' : 'api', ga = q.resolve(fa) + '/restserver.php', ha = ES(y, 'bind', true, null, da, '/restserver.php', 'get', ca);
                x(ga, 'get', ca, ha);
            }

            var ba = ES('Object', 'assign', false, new n(), {setAccessToken: function (ca) {
                s = ca;
        ...
        __d("sdk.UIServer", ["sdk.Auth", "sdk.Content", "createObjectFrom", "sdk.Dialog", "sdk.DOM", "sdk.Event", "flattenObject", "sdk.Frictionless", "sdk.getContextType", "guid", "insertIframe", "Log", "sdk.Native", "QueryString", "resolveURI", "sdk.RPC", "sdk.Runtime", "JSSDKConfig", "UrlMap", "UserAgent", "sdk.XD"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa) {
            var ba = {transform: function (ea) {
                ...
                } else ES('Object', 'assign', false, ea.params, {client_id: w.getClientID(), redirect_uri: u(da.xdHandler(fa, ga, 'opener', g.getAuthResponse(), 'permissions.oauth')), origin: o(), response_type: ha, domain: location.hostname});
                return ea;
                ...
                } else q({url: ea.url, root: ea.root, className: ea.className, width: ea.size.width, height: ea.size.height, id: ea.id, name: ea.frameName, onInsert: fa});
        ...
        __d("legacy:fb.event", ["FB", "sdk.Event"], function (a, b, c, d, e, f, g, h) {
            g.provide('Event', {subscribe: ES(h.subscribe, 'bind', true, h), unsubscribe: ES(h.unsubscribe, 'bind', true, h)});
        }, 3);
        ...
        __d("sdk.XFBML.CommentsCount", ["sdk.Data", "sdk.DOM", "sdk.XFBML.Element", "sprintf"], function (a, b, c, d, e, f, g, h, i, j) {
            var k = i.extend({process: function () {
                ...
                g._selectByIndex(['commentsbox_count'], 'link_stat', 'url', l).wait(ES(function (m) {
        ...
        __d("sdk.Anim", ["sdk.DOM"], function (a, b, c, d, e, f, g) {
            var h = {ate: function (i, j, k, l) {
                ...
                var m = 40, n = {}, o = {}, p = null, q = setInterval(ES(function () {
        ...
        __d("sdk.XFBML.ConnectBar", ["sdk.Anim", "sdk.api", "sdk.Auth", "createArrayFrom", "JSSDKConnectBarConfig", "sdk.Data", "sdk.DOM", "sdk.XFBML.Element", "escapeHTML", "sdk.Event", "format", "sdk.Helper", "sdk.Insights", "sdk.Intl", "sdk.Runtime", "UrlMap", "UserAgent"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w) {
            var x = n.extend({_initialHeight: null, _initTopMargin: 0, _picFieldName: 'pic_square', _page: null, _displayed: false, _notDisplayed: false, _container: null, _animationSpeed: 0, process: function () {
                i.getLoginStatus(ES(function (y) {
                    p.monitor('auth.statusChange', ES(function () {
                        if (this.isValid() && u.getLoginStatus() == 'connected') {
                            ...
                            h({method: 'Connect.shouldShowConnectBar'}, ES(function (z) {
                                if (z != 2) {
                ...
                var ca = {marginTop: this._initTopMargin + this._initialHeight + 'px'};
                if (w.ie()) {
                ...
                switch (z.className) {
                    ...
                    case 'fb_no_thanks':
                        ...
                        h({method: 'auth.revokeAuthorization', block: true}, ES(function () {
        ...
        __d("sdk.XFBML.Name", ["sdk.Data", "escapeHTML", "sdk.Event", "sdk.XFBML.Element", "sdk.Helper", "Log", "sdk.Runtime"], function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
            var n = j.extend({process: function () {
        ...
        __d("sdk.XFBML.SocialContext", ["sdk.Event", "sdk.XFBML.IframeWidget"], function (a, b, c, d, e, f, g, h) {
            var i = h.extend({setupAndValidate: function () {
                ...
                var k = {pluginID: this.getAttribute('plugin-id'), socialContextPageIDs: ES('JSON', 'parse', false, j.social_context_page_ids)};
        ...
        __d("legacy:fb.xfbml", ["Assert", "sdk.domReady", "sdk.Event", "FB", "IframePlugin", "PluginTags", "wrapFunction", "XFBML", "sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.ConnectBar", "sdk.XFBML.LoginButton", "sdk.XFBML.Name", "sdk.XFBML.RecommendationsBar", "sdk.XFBML.Registration", "sdk.XFBML.SocialContext"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
            var o = {comments: b('sdk.XFBML.Comments'), comments_count: b('sdk.XFBML.CommentsCount'), connect_bar: b('sdk.XFBML.ConnectBar'), login_button: b('sdk.XFBML.LoginButton'), name: b('sdk.XFBML.Name'), recommendations_bar: b('sdk.XFBML.RecommendationsBar'), registration: b('sdk.XFBML.Registration'), social_context: b('sdk.XFBML.SocialContext')};
        ...
        __d("legacy:fb.xfbml-legacy", ["FB", "sdk.Event"], function (a, b, c, d, e, f, g, h) {
            g.provide('XFBML.RecommendationsBar', {markRead: function (i) {
    ...
    new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1335099","message":"' + e.message + '"}}');
}