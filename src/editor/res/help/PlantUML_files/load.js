...
var FlattrLoader = function () {
    "use strict";
    var a = {instance: !1, queryString: !1, validParams: ["mode", "https", "uid", "category", "button", "language", "html5-key-prefix", "popout", "revsharekey"], validButtonParams: ["uid", "owner", "category", "button", "language", "hidden", "tags", "title", "url", "description", "revsharekey", "popout"], options: {}, POPOUT_WIDTH: 401, POPOUT_HEIGHT: 230, TIMEOUT: 1500, createIframe: function (b) {
        ...
        a.href && (g.url = a.href), a.getAttribute("title") && (g.title = a.getAttribute("title")), a.getAttribute("lang") && (g.language = a.getAttribute("lang")), a.innerHTML && (g.description = a.innerHTML);
        ...
        var d, e = {};
        for (d in this.options)this.options.hasOwnProperty(d) && this.validParam(d, this.validButtonParams) && (e[d] = this.options[d]);
        try {
        ...
        if (typeof b == "string")if (typeof document.documentElement.outerHTML != "undefined")a.outerHTML = b; else {
