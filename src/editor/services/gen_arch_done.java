...
public class gen_arch_done {
    public static void pre_combine(ArrayList<Module> modules_arr){
        ...
        combine(modules_arr,modd_arr_sellected,modd_arr_sellected.size());
    }

    public static void combine(ArrayList<Module> modules_arr, ArrayList<Integer> modd_arr_sell,int s_pos){
