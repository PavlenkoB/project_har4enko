...
public class gen_arch_done {
    public static ArrayList<Architecture> pre_combine(Architecture origin_arch, ArrayList<Module> modules_arr_not_selected) {
        ...
        for (int s_mod = 0; s_mod < modules_arr_not_selected.size(); s_mod++) {
            modd_arr_sellected.add(s_mod, 0);
        }
        combine(return_Architectures, origin_arch, modules_arr_not_selected, modd_arr_sellected, modd_arr_sellected.size());
